...
function PostsDAO(db) {
    ...
    // Verify: db.posts.find().sort({date:-1}).limit(10).explain();
    ...
    // Verify: db.posts.find({tags:'pasta'}).sort({date:-1}).limit(10).explain()
    ...
    // Verify: db.posts.findOne({permalink: 'ujrrwrdsqtedvtqpsegq'}).explain()
